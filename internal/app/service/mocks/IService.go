...
func (_m *IService) CreateURL(ctx context.Context, url string) (string, error) {
...
func (_m *IService) DeleteUserURLs(ctx context.Context, data []string) error {
...
func (_m *IService) GetURL(ctx context.Context, id string) (string, error) {
...
func (_m *IService) GetUserURLs(ctx context.Context) ([]models.UserURL, error) {
	ret := _m.Called(ctx)
...
// JSONHandle provides a mock function with given fields: ctx, url
func (_m *IService) JSONHandle(ctx context.Context, url string) (string, error) {
	ret := _m.Called(ctx, url)

	if len(ret) == 0 {
		panic("no return value specified for JSONHandle")
	}
...
func (_m *IService) JSONHandleBatch(ctx context.Context, data []models.RequestBatch) ([]models.ResponseBatch, error) {
	ret := _m.Called(ctx, data)
...
func (_m *IService) PingDB(ctx context.Context) error {
	ret := _m.Called(ctx)
